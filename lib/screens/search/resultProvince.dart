...
class SearchResultsProvince extends StatefulWidget {
  final String province;
  SearchResultsProvince({this.province});
  @override
  _SearchResultsProvinceState createState() => _SearchResultsProvinceState();
}

class _SearchResultsProvinceState extends State<SearchResultsProvince> {
  String searchString;
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            "Schools According to ${widget.province}",
            style: TextStyle(
