import 'package:find_my_school_updated/screens/search/resultSector.dart';
                      ...
                      child: FlatButton(
                          onPressed: () {
                            Navigator.push(
                                context,
                                PageTransition(
                                    child: SearchResultSector(
                                      sector: sectorList[index].toString(),
                                    ),
                ...
                child: FlatButton(
                    onPressed: () {
                      Navigator.push(
                          ...
                          PageTransition(
                              child: SearchResultSector(
                                sector: sectorList[sectorList.length - 1]
                                    .toString(),
                              ),
                              type: PageTransitionType.fade));
                    },
