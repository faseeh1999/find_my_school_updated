...
class SearchResultsFee extends StatefulWidget {
  final int lowerfee;
  final int upperfee;
  SearchResultsFee({this.lowerfee, this.upperfee});

  @override
  _SearchResultsFeeState createState() => _SearchResultsFeeState();
}

class _SearchResultsFeeState extends State<SearchResultsFee> {
  String searchString;
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            "Schools Between RS: ${widget.lowerfee} - ${widget.upperfee}",
            style: TextStyle(
          ...
          Expanded(
            ...
            stream: (widget.lowerfee == null ||
                ...
                : Firestore.instance
                    ...
                    // .where("upperfeerange",
                    //     isLessThanOrEqualTo: widget.upperfee)
