...
class SearchResultSector extends StatefulWidget {
  final String sector;
  SearchResultSector({this.sector});
  @override
  _SearchResultSectorState createState() => _SearchResultSectorState();
}

class _SearchResultSectorState extends State<SearchResultSector> {
  String searchString;
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            "Schools According to ${widget.sector}",
            style: TextStyle(
          ...
          Expanded(
            ...
            stream: (widget.sector == null || widget.sector.trim() == "")
                ? Firestore.instance.collection('institutes').snapshots()
                : Firestore.instance
                    .collection('institutes')
                    .where("sector", isEqualTo: widget.sector)
