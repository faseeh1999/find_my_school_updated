...
class SearchResultsCity extends StatefulWidget {
  final String city;
  SearchResultsCity({this.city});

  @override
  _SearchResultsCityState createState() => _SearchResultsCityState();
}

class _SearchResultsCityState extends State<SearchResultsCity> {
  String searchString;
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            "Schools According to ${widget.city}",
            style: TextStyle(
